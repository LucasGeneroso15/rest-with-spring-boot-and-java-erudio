...
public class PersonController {
	...
	@Operation(summary = "Adds a new Persons", description = "Adds a new Person by passing in JSON, XML or YML representation of Person",
			tags = {"People"},
			responses = {
					@ApiResponse(description = "Success", responseCode = "200",
							content = @Content( schema = @Schema(implementation = PersonVO.class)	)),
	...
	@Operation(summary = "Updates a Person", description = "Updates a Person by passing in JSON, XML or YML representation of Person",
			tags = {"People"},
			responses = {
	...
	@Operation(summary = "Deletes a Person", description = "Deletes a Person by passing in JSON, XML or YML representation of Person",
			tags = {"People"},
			responses = {
					@ApiResponse(description = "No Content", responseCode = "204",	content = @Content()),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content()),
