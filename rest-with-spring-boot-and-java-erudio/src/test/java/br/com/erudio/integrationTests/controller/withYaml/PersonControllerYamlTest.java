...
import br.com.erudio.integrationTests.vo.wrappers.PagedModelPerson;
...
public class PersonControllerYamlTest extends AbstractIntegrationTest {
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8080/api/person/v1/677\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8080/api/person/v1/846\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8080/api/person/v1/714\""));
